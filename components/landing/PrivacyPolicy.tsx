          ...
          >
            <div className="prose prose-lg max-w-none legal-content">
              ...
              <Section number="1" title="INFORMATION WE COLLECT">
                <h4 className="text-lg font-bold text-[#006D77] mt-6 mb-3">1.1 Information You Provide Directly</h4>
                ...
                <h4 className="text-lg font-bold text-[#006D77] mt-6 mb-3">1.2 Information Collected Automatically</h4>
                ...
                <h4 className="text-lg font-bold text-[#006D77] mt-6 mb-3">1.3 Information from Third Parties</h4>
                <p>
              ...
              {/* Section 3 */}
              <Section number="3" title="INFORMATION SHARING AND DISCLOSURE">
                ...
                <h4 className="text-lg font-bold text-[#006D77] mt-6 mb-3">3.1 With Pool Members</h4>
                <p>
                ...
                <h4 className="text-lg font-bold text-[#006D77] mt-6 mb-3">3.2 With Service Providers</h4>
                  ...
                  <table className="w-full border-collapse">
                    <thead>
                      <tr className="bg-[#EDF6F9]">
                        <th className="border border-[#006D77]/20 px-4 py-3 text-left text-[#006D77] font-bold">Provider</th>
                        <th className="border border-[#006D77]/20 px-4 py-3 text-left text-[#006D77] font-bold">Purpose</th>
                      </tr>
                    </thead>
                    <tbody className="text-[#006D77]/80">
                      <tr>
                        <td className="border border-[#006D77]/20 px-4 py-3">Supabase</td>
                        <td className="border border-[#006D77]/20 px-4 py-3">Database hosting, authentication, and file storage</td>
                      </tr>
                      <tr className="bg-[#EDF6F9]/50">
                        <td className="border border-[#006D77]/20 px-4 py-3">Stripe</td>
                        <td className="border border-[#006D77]/20 px-4 py-3">Payment processing and subscription management</td>
                      </tr>
                      <tr>
                        <td className="border border-[#006D77]/20 px-4 py-3">Analytics Providers</td>
                        <td className="border border-[#006D77]/20 px-4 py-3">Usage analytics and crash reporting</td>
                      </tr>
                      <tr className="bg-[#EDF6F9]/50">
                        <td className="border border-[#006D77]/20 px-4 py-3">Push Notification Services</td>
                        <td className="border border-[#006D77]/20 px-4 py-3">Delivering push notifications</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <h4 className="text-lg font-bold text-[#006D77] mt-6 mb-3">3.3 For Legal Reasons</h4>
                <p>
                ...
                <h4 className="text-lg font-bold text-[#006D77] mt-6 mb-3">3.4 Business Transfers</h4>
                <p>
              ...
              <Section number="4" title="DATA SECURITY">
                ...
                <div className="bg-[#FFDDD2]/30 border border-[#E29578]/30 rounded-xl p-4 sm:p-6 mt-6">
              ...
              <Section number="6" title="YOUR RIGHTS AND CHOICES">
                ...
                <h4 className="text-lg font-bold text-[#006D77] mt-6 mb-3">6.3 California Residents (CCPA Rights)</h4>
                <div className="bg-[#EDF6F9] rounded-xl p-4 sm:p-6 mt-4">
                  <p className="text-[#006D77] font-medium mb-3">If you are a California resident, you have the following rights under the California Consumer Privacy Act (CCPA):</p>
                ...
                <p className="mt-4">
                  To exercise these rights, please contact us at <a href="mailto:privacy@shanesretirementfund.com" className="text-[#E29578] hover:underline">privacy@shanesretirementfund.com</a>. We will verify your identity before processing your request.
                </p>

                <h4 className="text-lg font-bold text-[#006D77] mt-6 mb-3">6.4 European Residents (GDPR Rights)</h4>
                <div className="bg-[#EDF6F9] rounded-xl p-4 sm:p-6 mt-4">
                  <p className="text-[#006D77] font-medium mb-3">If you are a resident of the European Economic Area (EEA), you have the following rights under the General Data Protection Regulation (GDPR):</p>
                  <ul className="space-y-2 text-[#006D77]/80">
                ...
                <p className="mt-4">
                  To exercise these rights, please contact us at <a href="mailto:privacy@shanesretirementfund.com" className="text-[#E29578] hover:underline">privacy@shanesretirementfund.com</a>.
                </p>
              </Section>
              ...
              <Section number="11" title="CONTACT US">
                ...
                <div className="bg-[#EDF6F9] rounded-xl p-4 sm:p-6 mt-4">
                  <p className="font-bold text-[#006D77] mb-3">Shane's Retirement Fund</p>
                  <p className="text-[#006D77]/80">Privacy Inquiries: <a href="mailto:privacy@shanesretirementfund.com" className="text-[#E29578] hover:underline">privacy@shanesretirementfund.com</a></p>
                  <p className="text-[#006D77]/80">General Support: <a href="mailto:support@shanesretirementfund.com" className="text-[#E29578] hover:underline">support@shanesretirementfund.com</a></p>
                  <p className="text-[#006D77]/80">Data Protection Officer: <a href="mailto:dpo@shanesretirementfund.com" className="text-[#E29578] hover:underline">dpo@shanesretirementfund.com</a></p>
                </div>
              </Section>
              ...
              <Section number="12" title="DATA PROCESSING SUMMARY">
                ...
                <div className="overflow-x-auto mt-4">
                  <table className="w-full border-collapse text-sm">
                    <thead>
                      <tr className="bg-[#EDF6F9]">
                        <th className="border border-[#006D77]/20 px-3 py-3 text-left text-[#006D77] font-bold">Category</th>
                        <th className="border border-[#006D77]/20 px-3 py-3 text-left text-[#006D77] font-bold">Examples</th>
                        <th className="border border-[#006D77]/20 px-3 py-3 text-left text-[#006D77] font-bold">Purpose</th>
                        <th className="border border-[#006D77]/20 px-3 py-3 text-left text-[#006D77] font-bold">Legal Basis</th>
                      </tr>
                    </thead>
                    <tbody className="text-[#006D77]/80">
                      <tr>
                        <td className="border border-[#006D77]/20 px-3 py-3">Identifiers</td>
                        <td className="border border-[#006D77]/20 px-3 py-3">Email, name, device ID</td>
                        <td className="border border-[#006D77]/20 px-3 py-3">Account management</td>
                        <td className="border border-[#006D77]/20 px-3 py-3">Contract performance</td>
                      </tr>
                      <tr className="bg-[#EDF6F9]/50">
                        <td className="border border-[#006D77]/20 px-3 py-3">Commercial Info</td>
                        <td className="border border-[#006D77]/20 px-3 py-3">Subscription data</td>
                        <td className="border border-[#006D77]/20 px-3 py-3">Billing, support</td>
                        <td className="border border-[#006D77]/20 px-3 py-3">Contract performance</td>
                      </tr>
                      <tr>
                        <td className="border border-[#006D77]/20 px-3 py-3">Internet Activity</td>
                        <td className="border border-[#006D77]/20 px-3 py-3">Usage data, logs</td>
                        <td className="border border-[#006D77]/20 px-3 py-3">Analytics, security</td>
                        <td className="border border-[#006D77]/20 px-3 py-3">Legitimate interest</td>
                      </tr>
                      <tr className="bg-[#EDF6F9]/50">
                        <td className="border border-[#006D77]/20 px-3 py-3">Geolocation</td>
                        <td className="border border-[#006D77]/20 px-3 py-3">General location (IP)</td>
                        <td className="border border-[#006D77]/20 px-3 py-3">Compliance, analytics</td>
                        <td className="border border-[#006D77]/20 px-3 py-3">Legitimate interest</td>
                      </tr>
                    </tbody>
                  </table>
