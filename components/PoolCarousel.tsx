...
const PoolCard: React.FC<{ pool: DisplayPool; onPoolClick?: (poolId: string) => void }> = ({ pool, onPoolClick }) => {
  ...
  return (
    <motion.div
      ...
      role="button"
      tabIndex={0}
      className="w-full md:min-h-[380px] relative rounded-[2.5rem] sm:rounded-[3rem] overflow-hidden bg-white p-5 sm:p-7 flex flex-col justify-between group cursor-pointer border border-[#FFDDD2] warm-shadow transition-all duration-300"
    >
